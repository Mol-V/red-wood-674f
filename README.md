...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/red-wood-674f
```

A live public deployment of this template is available at [https://red-wood-674f.templates.workers.dev](https://red-wood-674f.templates.workers.dev)
